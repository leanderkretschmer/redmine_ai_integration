(function() {
  ...
  function createAIButtons(textarea) {
    ...
    complexButton.innerHTML = '<svg class="s18 icon-svg" aria-hidden="true" style="width:18px; height:18px; vertical-align:middle; fill:currentColor;"><use href="/assets/icons-35b4b65e.svg#icon--edit"></use></svg><span class="btn-text">Erweitern</span>';
